...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListBox ID="lstOrderList" runat="server" Height="623px" Width="757px"></asp:ListBox>
        <p>
            <asp:Button ID="btnAdd" runat="server" Height="29px" OnClick="btnAdd_Click" Text="Add" Width="68px" />
